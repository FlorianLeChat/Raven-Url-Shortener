...
export default function CookieConsent()
{
	...
	{
		const { linkedCategory } = section;

		if ( linkedCategory === "analytics" && process.env.NEXT_PUBLIC_ANALYTICS_ENABLED !== "true" )
		{
			// Google Analytics est désactivé.
			return false;
		}

		if ( linkedCategory === "security" && process.env.NEXT_PUBLIC_RECAPTCHA_ENABLED !== "true" )
		{
