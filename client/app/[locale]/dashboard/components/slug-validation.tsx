		...
		<Input
			...
			description={(
				<p className="text-default-500">
					...
					<strong>manière unique</strong> une ressource sur Internet.
					Vous avez la possibilité de personnaliser le slug de votre
					lien pour le rendre plus facile à mémoriser.
				</p>
			)}
			errorMessage={isAvailable ? undefined : "Ce slug est déjà utilisé. Veillez en choisir un autre."}
			startContent={(
